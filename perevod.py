...
def preprocess(examples):
    # examples — словарь списков при batched=True
...
# -----------------------------
# 4. DataCollator (правильная упаковка батчей)
# -----------------------------
...
training_args = Seq2SeqTrainingArguments(
    ...
    save_total_limit=2,  # сохранять только 2 последних чекпойнта
)
...
# 8. сохранение модели
# -----------------------------
trainer.save_model("akkadian_mt5_model")
tokenizer.save_pretrained("akkadian_mt5_model")